...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 01, 2025 at 06:52 PM
...
CREATE TABLE `pricings` (
  ...
  `price_feature1` varchar(255) NOT NULL,
  `price_feature2` varchar(255) NOT NULL,
  `price_feature3` varchar(255) NOT NULL,
  `price_feature4` varchar(255) NOT NULL,
  `price_feature5` varchar(255) NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
