<x-dashboard>
    ...
    >
        ...
        <div class="max-w-7xl mx-auto p-3 sm:p-6">
            ...
            <!-- Quick Action Cards - Only Order List and Manage Users -->
            <div class="mb-8">
                <h2 class="text-xl font-semibold text-gray-800 mb-4">Quick Actions</h2>
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <a href="/dashboard/admin/orderlist" class="bg-white rounded-lg shadow-md p-4 sm:p-6 text-center hover:shadow-lg transition-shadow duration-300 hover:bg-yellow-50 cursor-pointer group">
                    ...
                    <a href="/dashboard/admin/manageuser" class="bg-white rounded-lg shadow-md p-4 sm:p-6 text-center hover:shadow-lg transition-shadow duration-300 hover:bg-yellow-50 cursor-pointer group">
                        <div class="inline-flex items-center justify-center p-3 bg-yellow-100 rounded-full text-yellow-500 mb-4 group-hover:bg-yellow-200 transition-colors duration-300">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
