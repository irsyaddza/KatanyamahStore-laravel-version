            ...
            <div class="hidden md:block">
                <div class="ml-4 flex items-center md:ml-6">
                    ...
                    <div class="relative ml-3" x-data="{ profileOpen: false }">
                        <div>
                            <button type="button" @click.stop="profileOpen = !profileOpen"
                        ...
                        <div x-show="profileOpen" x-transition:enter="transition ease-out duration-200 transform"
                            x-transition:enter-start="opacity-0 scale-95" x-transition:enter-end="opacity-100 scale-100"
                            x-transition:leave="transition ease-in duration-150 transform"
                            x-transition:leave-start="opacity-100 scale-100" x-transition:leave-end="opacity-0 scale-95"
                            @click.away="profileOpen = false"
                            class="absolute right-0 z-50 mt-2 w-48 origin-top-right rounded-md bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 py-1 ring-1 shadow-lg ring-black/5 focus:outline-none"
                            ...
                            <div class="pointer-events-auto">                                
                                ...
                                <form action="/logout" method="POST" class="block w-full">
                                    @csrf
                                    <button type="submit"
                                        class="block w-full text-left px-4 py-2 text-sm text-gray-300 hover:bg-gray-700 hover:text-yellow-400 transition-colors"
