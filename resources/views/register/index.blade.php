<x-layout>
    <div class="min-h-screen flex items-center justify-center px-4 py-8 sm:py-12 bg-yellow-400">
        <div class="container mx-auto max-w-md">
            <!-- Register Form Card with floating elements -->
            <div class="relative bg-gray-800 rounded-xl shadow-xl overflow-hidden w-full transform transition-all duration-300 hover:shadow-2xl mx-auto border border-gray-700">
                ...
                <div class="p-6 sm:p-8 relative z-10">
                    ...
                    <div class="text-center mb-8">
                        ...
                        <p class="mt-3 text-gray-400 text-sm">Join our community today</p>
                    </div>
                        ...
                        <div class="mb-5">
                            ...
                            <div class="relative group">
                                ...
                                <input 
                                    ...
                                    name="email" 
                                    x-model="email"
                                    class="bg-gray-700 border text-white text-sm rounded-lg focus:ring-yellow-400 focus:border-yellow-400 block w-full pl-10 p-3 transition-all @error('email') border-red-500 @enderror" 
                                    placeholder="name@example.com"
                                    required
                                >
                                <!-- Animated focus border using Alpine states -->
                                <div class="absolute bottom-0 left-0 h-0.5 bg-yellow-400 transition-all duration-300"
                                    :class="email ? 'w-full' : 'w-0'"></div>
                            </div>
                            @error('email')
                                <p class="mt-1 text-sm text-red-400">{{ $message }}</p>
                            @enderror
                    ...
                    <div class="mt-8 text-center">
                        <p class="text-sm text-gray-300">
                            ...
                            <a href="login" class="font-medium text-yellow-400 hover:text-yellow-300 hover:underline transition-all">Sign in</a>
                        </p>
                    </div>
                </div>
            </div>
